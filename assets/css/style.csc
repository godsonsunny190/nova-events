...
.section-title .section-title-flex .line {
...
.section-title .section-title-flex .line::before {
  content: "";
  background-color: #c5a47e;
  width: 4px;
  height: 4px;
...
.section-title .section-title-flex .line:last-child {
...
.btn-default:hover.btn-highlighted::after {
  background-color: #555555;
}
...
.hero_content h1, .hero_content .h1 {
  font-size: 60px;
  font-weight: 600;
  text-transform: uppercase;
}
.hero_content h2, .hero_content .h2 {
  font-size: 40px;
  font-weight: 600;
  text-transform: uppercase;
  margin-top: 8px;
}
.hero_content h2 b, .hero_content .h2 b {
  color: #c5a47e;
}
.hero::after {
  content: "";
...
.service_content h4, .service_content .h4 {
  font-size: 20px;
  font-weight: 600;
  color: #ffffff;
  text-transform: capitalize;
...
.projects_slider .slick-dots li button:before {
  color: #c5a47e;
  font-size: 10px;
}
.projects_item {
...
.projects_item:hover .projects_content {
  bottom: 0;
}
.projects_item:hover .line {
  width: 100%;
  transition: all 0.8s ease-in-out;
}
.projects_item:hover .arrow {
  filter: brightness(0) saturate(100%) invert(70%) sepia(37%) saturate(310%) hue-rotate(352deg) brightness(90%) contrast(90%);
}
.projects_item img {
  transition: all 0.5s;
  min-height: 382px;
...
.projects_content h6, .projects_content .h6 {
  color: #b19777;
  font-size: 14px;
  font-weight: 400;
  margin: 0 0 10px 0;
...
.projects_content h5, .projects_content .h5 {
  color: #fff;
  font-size: 20px;
  font-weight: 500;
  margin: 0 0 10px 0;
...
.projects_content .arrow {
  color: #fff;
  font-size: 20px;
}
.projects_content .arrow:hover {
  color: #b19777;
}
.projects_content .arrow {
  width: 20px;
...
.equipment_item .cont .icon img {
  width: 25px;
}
.equipment_item .cont .icon.invert img {
  -webkit-filter: invert(1);
  filter: invert(1);
}
.equipment_item .cont h5, .equipment_item .cont .h5 {
  color: #fff;
  font-size: 22px;
  font-weight: 600;
}
.equipment_item .cont h6, .equipment_item .cont .h6 {
  color: #c5a47e;
  font-size: 16px;
  font-weight: 400;
  margin-top: 10px;
...
.equipment_item:hover.img::after {
  height: 250%;
  transition: all 600ms linear;
  background-color: transparent;
}
...
.cta-container {
  ...
  height: 280px;
  border-radius: 24px;
  background: linear-gradient(90deg, rgba(0, 0, 0, 0) 0%, rgba(25, 25, 25, 0.9) 50%, rgba(0, 0, 0, 0) 100%);
  position: relative;
  margin: 0 auto;
  overflow: hidden;
}
...
/*# sourceMappingURL=style.csc.map */
